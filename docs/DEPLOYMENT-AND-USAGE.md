...
![像搭一个小型工作室：理解内容、制作素材，再合成视频](assets/sponge/article-illustrations/01-studio.png)
...
![接入自己的声音，在本地配音，并将参考录音私有保存](assets/sponge/article-illustrations/02-own-voice.png)
...
![先做短片跑通流程，再扩展成完整长片](assets/sponge/article-illustrations/03-pilot.png)
...
![以锁定旁白为时间基准，对齐字幕和画面](assets/sponge/article-illustrations/04-timeline.png)
...
![保留已经完成的成果，只修复断点，然后继续完成视频](assets/sponge/article-illustrations/05-resume.png)
